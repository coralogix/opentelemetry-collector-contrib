...
// 			Dockerfile: "Dockerfile.zabbix.3_9",
// 		},
...
func TestZabbixIntegration(t *testing.T) {
	t.Run("Running zabbix 6.2", func(t *testing.T) {
		t.Parallel()
		...
		cfg.Endpoint = fmt.Sprintf("http://%s", hostname)
		cfg.Username = "Admin"
		cfg.Password = "zabbix"
